...
import net.mcreator.demonslayer.item.PepiteEcarlateItem;
...
public class MineraiDePepiteEcarlateBlock extends DemonSlayerModElements.ModElement {
	@ObjectHolder("demon_slayer:minerai_de_pepite_ecarlate")
	public static final Block block = null;
	public MineraiDePepiteEcarlateBlock(DemonSlayerModElements instance) {
		super(instance, 30);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("minerai_de_pepite_ecarlate");
		}
		...
		public void addInformation(ItemStack itemstack, IBlockReader world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Minerai permettant de r\u00E9cup\u00E9rer des p\u00E9pites \u00E9carlates."));
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(PepiteEcarlateItem.block, (int) (1)));
		}
	}
}
