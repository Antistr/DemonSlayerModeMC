...
import net.mcreator.demonslayer.procedures.LameDeNichirinIndigoQuandLoutilEstDansLinventaireParTickProcedure;
...
public class LameDeNichirinIndigoItem extends DemonSlayerModElements.ModElement {
	@ObjectHolder("demon_slayer:lame_de_nichirin_indigo")
	public static final Item block = null;
	public LameDeNichirinIndigoItem(DemonSlayerModElements instance) {
		super(instance, 42);
	}
	...
	public void initElements() {
		elements.items.add(() -> new SwordItem(new IItemTier() {
			...
			public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
				...
				list.add(new StringTextComponent("Arme des Pourfendeurs"));
				list.add(new StringTextComponent("Elle vous donne l'effet Vision nocturne"));
			}
			...
			public void inventoryTick(ItemStack itemstack, World world, Entity entity, int slot, boolean selected) {
				...
				}
				{
					Map<String, Object> $_dependencies = new HashMap<>();
					$_dependencies.put("entity", entity);
					LameDeNichirinIndigoQuandLoutilEstDansLinventaireParTickProcedure.executeProcedure($_dependencies);
				}
			}
		}.setRegistryName("lame_de_nichirin_indigo"));
	}
}
