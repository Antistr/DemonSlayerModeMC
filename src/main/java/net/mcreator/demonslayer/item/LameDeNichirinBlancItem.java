...
import net.mcreator.demonslayer.procedures.LameDeNichirinBlancQuandLoutilEstDansLinventaireParTickProcedure;
...
public class LameDeNichirinBlancItem extends DemonSlayerModElements.ModElement {
	@ObjectHolder("demon_slayer:lame_de_nichirin_blanc")
	public static final Item block = null;
	public LameDeNichirinBlancItem(DemonSlayerModElements instance) {
		super(instance, 43);
	}
	...
	public void initElements() {
		elements.items.add(() -> new SwordItem(new IItemTier() {
			...
			public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
				...
				list.add(new StringTextComponent("Elle vous donne l'effet Chute lente"));
			}
			...
			public void inventoryTick(ItemStack itemstack, World world, Entity entity, int slot, boolean selected) {
				...
				}
				{
					Map<String, Object> $_dependencies = new HashMap<>();
					$_dependencies.put("entity", entity);
					LameDeNichirinBlancQuandLoutilEstDansLinventaireParTickProcedure.executeProcedure($_dependencies);
				}
			}
		}.setRegistryName("lame_de_nichirin_blanc"));
	}
}
