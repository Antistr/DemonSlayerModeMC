...
import net.mcreator.demonslayer.procedures.LameDeNichirinRougeQuandLoutilEstDansLinventaireParTickProcedure;
...
public class LameDeNichirinRougeItem extends DemonSlayerModElements.ModElement {
	@ObjectHolder("demon_slayer:lame_de_nichirin_rouge")
	public static final Item block = null;
	public LameDeNichirinRougeItem(DemonSlayerModElements instance) {
		super(instance, 26);
	}
	...
	public void initElements() {
		elements.items.add(() -> new SwordItem(new IItemTier() {
			...
			public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
				...
				list.add(new StringTextComponent("Elle vous donne l'effet Resistance au feu."));
			}
			...
			public void inventoryTick(ItemStack itemstack, World world, Entity entity, int slot, boolean selected) {
				...
				}
				{
					Map<String, Object> $_dependencies = new HashMap<>();
					$_dependencies.put("entity", entity);
					LameDeNichirinRougeQuandLoutilEstDansLinventaireParTickProcedure.executeProcedure($_dependencies);
				}
			}
		}.setRegistryName("lame_de_nichirin_rouge"));
	}
}
