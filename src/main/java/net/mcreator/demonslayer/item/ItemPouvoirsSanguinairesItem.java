...
import net.mcreator.demonslayer.procedures.ItemPouvoirsSanguinairesLorsDunClicDroitDansLairProcedure;
...
public class ItemPouvoirsSanguinairesItem extends DemonSlayerModElements.ModElement {
	@ObjectHolder("demon_slayer:item_pouvoirs_sanguinaires")
	public static final Item block = null;
	public ItemPouvoirsSanguinairesItem(DemonSlayerModElements instance) {
		super(instance, 85);
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("item_pouvoirs_sanguinaires");
		}
		...
		public ActionResult<ItemStack> onItemRightClick(World world, PlayerEntity entity, Hand hand) {
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Item Pouvoires Sanguinaires");
					}
			...
			}
			{
				...
				ItemPouvoirsSanguinairesLorsDunClicDroitDansLairProcedure.executeProcedure($_dependencies);
			}
			return ar;
		}
