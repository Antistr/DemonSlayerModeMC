...
import net.mcreator.demonslayer.procedures.LameDeNichirinNoireQuandLoutilEstDansLinventaireParTickProcedure;
...
public class LameDeNichirinNoireItem extends DemonSlayerModElements.ModElement {
	@ObjectHolder("demon_slayer:lame_de_nichirin_noire")
	public static final Item block = null;
	public LameDeNichirinNoireItem(DemonSlayerModElements instance) {
		super(instance, 25);
	}
	...
	public void initElements() {
		elements.items.add(() -> new SwordItem(new IItemTier() {
			...
			public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
				...
				list.add(new StringTextComponent("Elle vous donne l'effet Heros du village"));
			}
			...
			public void inventoryTick(ItemStack itemstack, World world, Entity entity, int slot, boolean selected) {
				...
				}
				{
					Map<String, Object> $_dependencies = new HashMap<>();
					$_dependencies.put("entity", entity);
					LameDeNichirinNoireQuandLoutilEstDansLinventaireParTickProcedure.executeProcedure($_dependencies);
				}
			}
		}.setRegistryName("lame_de_nichirin_noire"));
	}
}
