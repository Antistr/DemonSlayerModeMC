...
import net.mcreator.demonslayer.procedures.LameDeNichirinVerteQuandLoutilEstDansLinventaireParTickProcedure;
...
public class LameDeNichirinVerteItem extends DemonSlayerModElements.ModElement {
	@ObjectHolder("demon_slayer:lame_de_nichirin_verte")
	public static final Item block = null;
	public LameDeNichirinVerteItem(DemonSlayerModElements instance) {
		super(instance, 39);
	}
	...
	public void initElements() {
		elements.items.add(() -> new SwordItem(new IItemTier() {
			...
			public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
				...
				list.add(new StringTextComponent("Elle vous donne l'effet Chance."));
			}
			...
			public void inventoryTick(ItemStack itemstack, World world, Entity entity, int slot, boolean selected) {
				...
				}
				{
					Map<String, Object> $_dependencies = new HashMap<>();
					$_dependencies.put("entity", entity);
					LameDeNichirinVerteQuandLoutilEstDansLinventaireParTickProcedure.executeProcedure($_dependencies);
				}
			}
		}.setRegistryName("lame_de_nichirin_verte"));
	}
}
