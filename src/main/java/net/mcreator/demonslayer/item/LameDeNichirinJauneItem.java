...
import net.mcreator.demonslayer.procedures.LameDeNichirinJauneQuandLoutilEstDansLinventaireParTickProcedure;
...
public class LameDeNichirinJauneItem extends DemonSlayerModElements.ModElement {
	@ObjectHolder("demon_slayer:lame_de_nichirin_jaune")
	public static final Item block = null;
	public LameDeNichirinJauneItem(DemonSlayerModElements instance) {
		super(instance, 27);
	}
	...
	public void initElements() {
		elements.items.add(() -> new SwordItem(new IItemTier() {
			...
			public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
				...
				list.add(new StringTextComponent("Elle vous donne l'effet C\u00E9lerit\u00E9"));
			}
			...
			public void inventoryTick(ItemStack itemstack, World world, Entity entity, int slot, boolean selected) {
				...
				}
				{
					Map<String, Object> $_dependencies = new HashMap<>();
					$_dependencies.put("entity", entity);
					LameDeNichirinJauneQuandLoutilEstDansLinventaireParTickProcedure.executeProcedure($_dependencies);
				}
			}
		}.setRegistryName("lame_de_nichirin_jaune"));
	}
}
