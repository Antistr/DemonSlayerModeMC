...
import net.mcreator.demonslayer.procedures.LameDeNichirinGrisQuandLoutilEstDansLinventaireParTickProcedure;
...
public class LameDeNichirinGrisItem extends DemonSlayerModElements.ModElement {
	@ObjectHolder("demon_slayer:lame_de_nichirin_gris")
	public static final Item block = null;
	public LameDeNichirinGrisItem(DemonSlayerModElements instance) {
		super(instance, 40);
	}
	...
	public void initElements() {
		elements.items.add(() -> new SwordItem(new IItemTier() {
			...
			public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
				...
				list.add(new StringTextComponent("Elle vous donne l'effet R\u00E9sistance"));
			}
			...
			public void inventoryTick(ItemStack itemstack, World world, Entity entity, int slot, boolean selected) {
				...
				}
				{
					Map<String, Object> $_dependencies = new HashMap<>();
					$_dependencies.put("entity", entity);
					LameDeNichirinGrisQuandLoutilEstDansLinventaireParTickProcedure.executeProcedure($_dependencies);
				}
			}
		}.setRegistryName("lame_de_nichirin_gris"));
	}
}
