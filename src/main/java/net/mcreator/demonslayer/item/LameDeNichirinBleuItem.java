...
import net.mcreator.demonslayer.procedures.LameDeNichirinBleuQuandLoutilEstDansLinventaireParTickProcedure;
...
public class LameDeNichirinBleuItem extends DemonSlayerModElements.ModElement {
	@ObjectHolder("demon_slayer:lame_de_nichirin_bleu")
	public static final Item block = null;
	public LameDeNichirinBleuItem(DemonSlayerModElements instance) {
		super(instance, 28);
	}
	...
	public void initElements() {
		elements.items.add(() -> new SwordItem(new IItemTier() {
			...
			public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
				...
				list.add(new StringTextComponent("Elle vous donne l'effet Gr\u00E2ce de dauphin"));
			}
			...
			public void inventoryTick(ItemStack itemstack, World world, Entity entity, int slot, boolean selected) {
				...
				}
				{
					Map<String, Object> $_dependencies = new HashMap<>();
					$_dependencies.put("entity", entity);
					LameDeNichirinBleuQuandLoutilEstDansLinventaireParTickProcedure.executeProcedure($_dependencies);
				}
			}
		}.setRegistryName("lame_de_nichirin_bleu"));
	}
}
